...
/**
 * "The rhythm" block: navy 28px block, sunshine eyebrow, Fraunces 44 title,
 * a short right-aligned note and the four numbered steps on a hairline.
 */
export function Rhythm({ eyebrow, title, note, steps }: { eyebrow: string; title: string; note: string; steps: PathStep[] }) {
  return (
